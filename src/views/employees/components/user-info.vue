    ...
    <el-form label-width="220px">
      <div class="block">
        ...
        <el-form-item label="护照号">
          <el-input v-model="formData.passportNo" class="inputW" placeholder="正规护照格式" />
        </el-form-item>
        <el-form-item label="身份证号">
          <el-input v-model="formData.idNumber" class="inputW" placeholder="正规身份证格式" />
        </el-form-item>
        <el-form-item label="籍贯">
          <el-input v-model="formData.nativePlace" class="inputW5" placeholder="籍贯地址" />
        </el-form-item>
        <el-form-item label="民族">
          <el-input v-model="formData.nation" class="inputW2" placeholder="请输入民族" />
        </el-form-item>
        ...
        <el-form-item label="生日">
          <el-input v-model="formData.birthday" class="inputW" placeholder="示例 0323" />
        </el-form-item>
      ...
      <div class="block">
        ...
        <el-form-item label="微信">
          <el-input v-model="formData.wechat" class="inputW" placeholder="请输入" />
        </el-form-item>
        ...
        <el-form-item label="个人邮箱">
          <el-input v-model="formData.personalMailbox" class="inputW" placeholder="请输入" type="mail" />
        </el-form-item>
        <el-form-item label="紧急联系人">
          <el-input v-model="formData.emergencyContact" class="inputW" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="紧急联系电话">
          <el-input v-model="formData.emergencyContactNumber" class="inputW" placeholder="11位字符" />
        </el-form-item>
      </div>
      <!-- 账号信息 -->
      <div class="block">
        ...
        <el-form-item label="社保电脑号">
          <el-input v-model="formData.socialSecurityComputerNumber" class="inputW" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="公积金账号">
          <el-input v-model="formData.providentFundAccount" class="inputW" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="银行卡号">
          <el-input v-model="formData.bankCardNumber" class="inputW" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="开户行">
          <el-input v-model="formData.openingBank" class="inputW" placeholder="请输入" />
        </el-form-item>
      </div>
      <!-- 教育信息 -->
      <div class="block">
        ...
        <el-form-item label="毕业学校">
          <el-input v-model="formData.graduateSchool" class="inputW2" placeholder="请输入" />
        </el-form-item>
        ...
        <el-form-item label="专业">
          <el-input v-model="formData.major" class="inputW" placeholder="请输入" />
        </el-form-item>
      </div>
      <!-- 从业信息 -->
      <div class="block">
        ...
        <el-form-item label="上家公司">
          <el-input v-model="formData.homeCompany" class="inputW" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="职称">
          <el-input v-model="formData.title" class="inputW" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="有无竞业限制">
          <el-input v-model="formData.isThereAnyCompetitionRestriction" placeholder="请输入" style="width:80%" />
        </el-form-item>
        <el-form-item label="备注">
          <el-input v-model="formData.remarks" placeholder="请输入备注" style="width:80%" type="textarea" />
        </el-form-item>
        <!-- 保存员工信息 -->
        <el-row class="inline-info" justify="center" type="flex">
          <el-col :span="12">
...
import { getPersonalDetail, getUserDetailById, saveUserDetailById, updatePersonal } from '@/api/user'
...
export default {
  ...
  methods: {
    ...
    async saveUser() {
      console.log(this.$refs.userInfoRef.fileList)
    ...
    async getUserDetailById() {
      ...
      // 服务器获取的图片链接赋值给头像组件里面的 fileList 直接就可以展示了
