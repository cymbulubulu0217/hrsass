  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img alt="" src="@/assets/common/head.jpg">
          </div>
    ...
    <el-row justify="space-between" type="flex">
      ...
      <el-col :span="13" style="padding-right:26px">
        ...
        <el-card class="box-card">
          ...
          <!-- 放置日历组件 -->
          <work-calendar :start-date="new Date()" />
        </el-card>
        <!-- 公告 -->
        <el-card class="box-card">
    ...
    <el-dialog :visible="showDialog" title="离职申请" @close="showDialog = false">
      ...
      <el-row justify="center" type="flex">
        <el-col :span="6">
          ...
          <el-button type="primary" @click="btnOk">确实</el-button>
        </el-col>
      </el-row>
    </el-dialog>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        exceptTime: [{ trigger: 'blur', methods: '请输入离职事件', required: true }],
        reason: [{ trigger: 'blur', methods: '请输入离职理由', required: true }]
      }
    }
  },
  computed: {
  ...
  methods: {
    btnOk() {
      ...
      this.$refs.formRef.validate(async validate => {
        if (validate) {
          const data = { ...this.ruleForm, userId: this.userInfo.id, username: this.userInfo.username }
